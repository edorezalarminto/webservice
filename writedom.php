<?php 
    ...
    {
        $mahasiswa= $doc->createElement('mahasiswa');                 //buat element baru <mahasiswa>
        ...
        {  
            ...
            $child = $mahasiswa->appendChild($child);           //masukkan sebagai anak dari element <mahasiswa>
    ...
    $doc->save("books.xml");   //simpan XML yang sudah dibuat ke file news.xml
?>